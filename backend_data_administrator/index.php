      ...
      <div class="container-fluid">
        ...
        <div class="card">
              <div class="card-header" style="background-color:#003399">
                <h3 class="card-title"><font color="#ffffff"><i class="fa-solid fa-user-plus"></i> Data Admin " Administrator</font></h3>
              </div>
              <!-- /.card-header -->
              <div class="card-body">
                ...
                <th>
                  <tb>
                    <tr>
                      ...
                      <input type="text" name="ed_nikterpilih2" class="form-control"></input></td>
                    </tr>
                    <tr>
                      <td width="30%">Nama Pengguna</td>
                      <td width="5%">:</td>
